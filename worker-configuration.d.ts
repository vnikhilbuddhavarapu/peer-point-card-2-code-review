/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d3598dde3a6868320ef480a4de0caae1)
// Runtime types generated with workerd@1.20260911.1 2026-09-18 nodejs_compat
interface __BaseEnv_Env {
	...
	PUBLIC_BASE_URL: "https://peer-point-code-review.peer-point-user-group.workers.dev";
	SANDBOX_TRANSPORT: "rpc";
	CODE_REVIEW_AGENT: DurableObjectNamespace<import("./src/server").CodeReviewAgent>;
	Sandbox: DurableObjectNamespace<import("./src/server").Sandbox>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "CodeReviewAgent" | "Sandbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_ID" | "CITY" | "CARD" | "ENVIRONMENT" | "PUBLIC_BASE_URL" | "SANDBOX_TRANSPORT">> {}
}
